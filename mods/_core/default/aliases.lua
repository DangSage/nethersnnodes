...
minetest.register_alias("WSword", "default:dirk_wood")
minetest.register_alias("STSword", "default:dirk_stone")
minetest.register_alias("SteelSword", "default:dirk_steel")
